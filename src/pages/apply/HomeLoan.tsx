...
const HomeLoan = () => {
  ...
  const handleWhatsAppRedirect = () => {
    const message = "Hi, I'm interested in applying for a Home Loan. Please provide more information.";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-12">
            <motion.div 
              className="w-20 h-20 bg-finn-500 rounded-2xl mx-auto mb-6 flex items-center justify-center"
            ...
            <p className="text-finn-600 text-lg">
              Turn your dream home into reality with our competitive home loan solutions.
            </p>
          </div>
