...
const CarLoan = () => {
  const features = [
    ...
    "Zero processing fee for select models",
  ...
  const handleWhatsAppRedirect = () => {
    const message = "Hi, I'm interested in applying for a Car Loan. Please provide more information.";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-12">
            <motion.div 
              className="w-20 h-20 bg-finn-800 rounded-2xl mx-auto mb-6 flex items-center justify-center"
            ...
            <p className="text-finn-600 text-lg">
              Drive your dream car home with our affordable car loans and quick approvals.
            </p>
          </div>
