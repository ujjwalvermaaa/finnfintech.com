...
const BusinessLoan = () => {
  const features = [
    ...
    "Special schemes for MSMEs"
  ];

  const requirements = [
    "Business vintage: Minimum 3 years",
    "Annual turnover: ₹25 Lakhs minimum",
    "Valid business proof (GST/Shop Act)",
  ...
  const handleWhatsAppRedirect = () => {
    const message = "Hi, I'm interested in applying for a Business Loan. Please provide more information.";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-12">
            <motion.div 
              className="w-20 h-20 bg-finn-600 rounded-2xl mx-auto mb-6 flex items-center justify-center"
            ...
            <p className="text-finn-600 text-lg">
              Fuel your business growth with our quick and hassle-free business loans.
            </p>
          </div>
